...
const MainContent: React.FC<MainContentProps> = ({ topic, onNavigate, prevTopic, nextTopic }) => {
  return (
    <main className="flex-1 p-4 md:p-8 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-6 md:p-10 rounded-xl shadow-sm">
