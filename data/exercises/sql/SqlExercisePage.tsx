...
import SqlExercises from './SqlExercises';
import SqlQuiz from './SqlQuiz';
...
const SqlExercisePage: React.FC = () => {
    const [activeView, setActiveView] = useState<ActiveView>('exercises');

    return (
        <div>
            <h1 className="text-5xl font-bold mb-4 text-gray-800 dark:text-gray-100">SQL Exercises</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">Test your SQL skills with our exercises and quizzes.</p>
            ...
            <div>
                {activeView === 'exercises' && <SqlExercises />}
                {activeView === 'quiz' && <SqlQuiz />}
            </div>
        </div>
    );
};

export default SqlExercisePage;
