...
const PythonExercisePage: React.FC = () => {
    const [activeView, setActiveView] = useState<ActiveView>('exercises');

    return (
        <div>
            <h1 className="text-5xl font-bold mb-4 text-gray-800 dark:text-gray-100">Python Exercises</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">Test your Python skills with our exercises and quizzes.</p>
            ...
            <div>
                {activeView === 'exercises' && <PythonExercises />}
                {activeView === 'quiz' && <PythonQuiz />}
            </div>
        </div>
    );
};

export default PythonExercisePage;
