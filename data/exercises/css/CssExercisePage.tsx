...
const CssExercisePage: React.FC = () => {
    const [activeView, setActiveView] = useState<ActiveView>('exercises');

    return (
        <div>
            <h1 className="text-5xl font-bold mb-4 text-gray-800 dark:text-gray-100">CSS Exercises</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">Test your CSS skills with our exercises and quizzes.</p>
            ...
            <div>
                {activeView === 'exercises' && <CssExercises />}
                {activeView === 'quiz' && <CssQuiz />}
            </div>
        </div>
    );
};
