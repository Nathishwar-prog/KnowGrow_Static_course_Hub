...
const HtmlImages: React.FC = () => (
  <>
    ...
    <CodeBlock language="html">{`<img src="img_chania.jpg" alt="Flowers in Chania">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<img src="img_girl.jpg" alt="Girl in a jacket" width="500" height="600">`}</CodeBlock>
    <div className="my-6 p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg text-center">
    ...
    <CodeBlock language="html">{`<img src="img_girl.jpg" alt="Girl in a jacket" style="width:500px;height:600px;">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<img src="https://www.w3schools.com/images/w3schools_green.jpg" alt="W3Schools.com">`}</CodeBlock>
...
<img src="images/picture.jpg" alt="My Picture">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<img src="programming.gif" alt="Computer Man" style="width:48px;height:48px;">`}</CodeBlock>
    <div className="my-6 p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg text-center">
