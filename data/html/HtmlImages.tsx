...
const HtmlImages: React.FC = () => (
  <>
    ...
    <div className="my-6 p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg text-center">
        <img src="https://picsum.photos/seed/chania/800/533" alt="Flowers in Chania" className="mx-auto rounded-md shadow-lg" />
    ...
    <CodeBlock language="html">{`<img src="url" alt="alternatetext">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<img src="https://picsum.photos/seed/chania/800/533" alt="Flowers in Chania">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<img src="https://picsum.photos/seed/girl/500/600" alt="Girl in a jacket" width="500" height="600">`}</CodeBlock>
    <div className="my-6 p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg text-center">
        <img src="https://picsum.photos/seed/girl/500/600" alt="Girl in a jacket" width="250" height="300" className="mx-auto rounded-md shadow-lg" />
    </div>
    ...
    <CodeBlock language="html">{`<img src="https://picsum.photos/seed/girl/500/600" alt="Girl in a jacket" style="width:500px;height:600px;">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<img src="https://via.placeholder.com/215x80/10B981/FFFFFF?text=KnowGrow" alt="KnowGrow.dev Logo">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<!-- Image is in the same folder as the current page -->
...
<img src="images/picture.jpg" alt="My Picture">`}</CodeBlock>
    ...
    <CodeBlock language="html">{`<img src="https://i.gifer.com/origin/2b/2ba034516804f3235b2c45585f95fe33_w200.gif" alt="Computer Man" style="width:48px;height:48px;">`}</CodeBlock>
    <div className="my-6 p-4 bg-gray-100 dark:bg-gray-800/50 rounded-lg text-center">
        <img src="https://i.gifer.com/origin/2b/2ba034516804f3235b2c45585f95fe33_w200.gif" alt="Computer Man" style={{width:'48px', height:'48px'}} className="mx-auto" />
    </div>
