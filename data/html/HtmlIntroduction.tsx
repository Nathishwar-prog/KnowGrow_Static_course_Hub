...
const HtmlIntroduction: React.FC = () => {
    ...
    return (
        <>
            ...
            <CodeBlock language="html" animationId="html-document-structure">{`<!DOCTYPE html>
<html>
<head>
...
<p>My first paragraph.</p>
            ...
            <div className="text-center -mt-2 mb-6">
                <button
                    onClick={() => openAnimationPage({ animationId: 'html-render-process' })}
                    className="inline-flex items-center bg-green-600 text-white font-bold py-2 px-4 rounded-full hover:bg-green-700 transition-colors shadow-md animate-pulse-green"
                >
                    <i className="fa-solid fa-play-circle mr-2"></i>
                    Animate Render Process
                </button>
            </div>
