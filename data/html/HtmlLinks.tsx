...
const HtmlLinks: React.FC = () => (
  <>
    ...
    <CodeBlock>{`<a href="url">link text</a>`}</CodeBlock>
    ...
    <CodeBlock>{`<a href="https://www.knowgrow.dev/" target="_blank">Visit KnowGrow</a>`}</CodeBlock>
    ...
    <CodeBlock>{`<a href="https://www.knowgrow.dev/html/default.asp">HTML tutorial</a>`}</CodeBlock>
    
    <h3 className="text-2xl font-bold mt-6 mb-3">Relative URL Example</h3>
    <CodeBlock>{`<a href="/html/default.asp">HTML tutorial</a>`}</CodeBlock>
  ...
  <img src="smiley.gif" alt="HTML tutorial" style="width:42px;height:42px;">
    ...
    <CodeBlock>{`<a href="mailto:someone@example.com">Send email</a>`}</CodeBlock>
    ...
    <CodeBlock>{`<button onclick="document.location='default.asp'">HTML Tutorial</button>`}</CodeBlock>
    ...
    <CodeBlock>{`<a href="https://www.knowgrow.dev/html/" title="Go to KnowGrow HTML section">Visit our HTML Tutorial</a>`}</CodeBlock>
