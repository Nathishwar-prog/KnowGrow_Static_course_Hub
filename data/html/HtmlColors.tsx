...
const HtmlColors: React.FC = () => (
  <>
    ...
    <CodeBlock>{`<h1 style="background-color:DodgerBlue;">Hello World</h1>
<p style="background-color:Tomato;">Lorem ipsum...</p>`}</CodeBlock>
    ...
    <CodeBlock>{`<h1 style="color:Tomato;">Hello World</h1>
...
<p style="color:MediumSeaGreen;">Ut wisi enim...</p>`}</CodeBlock>
    ...
    <CodeBlock>{`<h1 style="border:2px solid Tomato;">Hello World</h1>
...
<h1 style="border:2px solid Violet;">Hello World</h1>`}</CodeBlock>
    ...
    <CodeBlock>{`<h1 style="background-color:rgb(255, 99, 71);">...</h1>`}</CodeBlock>
    ...
    <CodeBlock>{`<h1 style="background-color:#ff6347;">...</h1>`}</CodeBlock>
    ...
    <CodeBlock>{`<h1 style="background-color:hsl(9, 100%, 64%);">...</h1>`}</CodeBlock>
    ...
    <CodeBlock>{`<h1 style="background-color:rgba(255, 99, 71, 0.5);">...</h1>
