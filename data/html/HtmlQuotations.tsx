...
const HtmlQuotations: React.FC = () => (
  <>
    ...
    <CodeBlock>{`<blockquote cite="http://www.worldwildlife.org/who/index.html">
For 60 years, WWF has worked to help people and nature thrive. As the world's leading conservation organization, WWF works in nearly 100 countries. At every level, we collaborate with people around the world to develop and deliver innovative solutions that protect communities, wildlife, and the places in which they live.
    ...
    <CodeBlock>{`<p>WWF's goal is to: <q>Build a future where people live in harmony with nature.</q></p>`}</CodeBlock>
    <div className="p-4 my-4 bg-gray-100 dark:bg-gray-800/50 rounded-md">
    ...
    <CodeBlock>{`<p>The <abbr title="World Health Organization">WHO</abbr> was founded in 1948.</p>`}</CodeBlock>
    <div className="p-4 my-4 bg-gray-100 dark:bg-gray-800/50 rounded-md">
...
USA
    ...
    <CodeBlock>{`<p><cite>The Scream</cite> by Edvard Munch. Painted in 1893.</p>`}</CodeBlock>
    <div className="p-4 my-4 bg-gray-100 dark:bg-gray-800/50 rounded-md">
    ...
    <CodeBlock>{`<bdo dir="rtl">This text will be written from right to left</bdo>`}</CodeBlock>
    <div className="p-4 my-4 bg-gray-100 dark:bg-gray-800/50 rounded-md">
